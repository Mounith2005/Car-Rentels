        ...
        <div className="carousel" ref={scrollRef}>
          {vehicles.map((v, i) => (
            <div className="card" key={i}>
              ...
              <h3>{v.name}</h3>
              <p className="price">{v.Rent} <span>Onwards</span></p>
              <div className="specs">
                <div><strong>{v.topSpeed}</strong><span>Top Speed</span></div>
                <div><strong>{v.mileage}</strong><span>mileage</span></div>
                <div><strong>{v.Seater}</strong><span></span></div>
              </div><br /><br /><br />
